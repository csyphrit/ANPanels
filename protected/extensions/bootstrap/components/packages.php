 ...
 */
 return array(
     ...
     'font-awesome'  => array(
         ...
         'css'     => array(YII_DEBUG ? '/www/css/font-awesome.css' : '/www/css/font-awesome.min.css'),      // dqj PLS -- added www prefix
     ),
     'font-awesome-ie7'  => array(
         'baseUrl' => $this->enableCdn ? '//netdna.bootstrapcdn.com/font-awesome/3.0.2/' : $this->getAssetsUrl(),
         'css'     => array('/www/css/font-awesome-ie7.min.css'), // dqj PLS -- added www prefix // only minified version exists in our assets and CDN serves minified version anyway
     ),
     'full.css'      => array(
         'baseUrl' => $this->enableCdn ? '//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/' : $this->getAssetsUrl(),
