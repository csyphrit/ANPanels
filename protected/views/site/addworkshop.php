 ...
 * @var string $error
 */
$this->pageTitle = Yii::app()->name . ' - Register Workshop';
...
<div id="addworkshop">
        <div class="form col-xs-6">
            ...
            <div class="form-group">
                ...
                echo CHtml::activeTextField($model, 'name', array('class' => 'form-control', 'maxlength' => 50, 'placeholder' => 'Workshop Name'));
	...
	<?php if (SiteSettings::getValue('DOUBLE')) { ?>
		...
		echo CHtml::activeHiddenField($model, 'double', array('value' => 0));
	}
	?>
...
?>
<script>
$('#WorkshopForm_description').keyup(function () {
  var max = 150;
